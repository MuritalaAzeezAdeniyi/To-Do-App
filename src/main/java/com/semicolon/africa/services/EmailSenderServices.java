...
//        Optional<Otp> otp = Optional.ofNullable(otpRepo.findByOtpCode(confirmTokenDto.getToken()));
//        if (otp.isPresent()) {
//            Otp finalOtp = otp.get();
//            Optional<User> user = userRepos.findById(finalOtp.getUserId());
